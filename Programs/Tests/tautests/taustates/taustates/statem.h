...
#define DEF_S0_TO_U1 0.0 //UNLIKELY
#define DEF_S0_TO_U2 0.0 //UNLIKELY
#define DEF_S0_TO_UM 0.0 //UNLIKELY
#define DEF_U0_TO_S0 0.0 //HIGHLY_LIKELY
#define DEF_S1_TO_U0 0.0 //LIKELY
#define DEF_S1_TO_UM 0.0 //UNLIKELY
#define DEF_U1_TO_S1 0.0 //HIGHLY_LIKELY
#define DEF_S2_TO_U0 0.0 //LIKELY
#define DEF_S2_TO_U1 0.0 //LIKELY
#define DEF_S2_TO_UM 0.0 //HIGHLY_UNLIKELY
#define DEF_U2_TO_S2 0.0 //HIGHLY_LIKELY
#define DEF_UM_TO_S0 0.0 //HIGHLY_LIKELY
#define DEF_UM_TO_U0 0.0 //LIKELY
#define DEF_UM_TO_S1 0.0 //HIGHLY_LIKELY
#define DEF_UM_TO_U1 0.0 //LIKELY
#define DEF_UM_TO_S2 0.0 //HIGHLY_LIKELY
#define DEF_UM_TO_U2 0.0 //LIKELY
#define DEF_UM_TO_SN 0.0 //HIGHLY_UNLIKELY
#define DEF_SN_TO_UM 0.0 //HIGHLY_LIKELY
